...
성남시 분당구의 행정동·법정동 경계를 한 화면에 여러 개 동시에 띄워 보는 페이지입니다.
네이버지도·카카오맵은 한 번에 한 구역만 검색되지만, 여기서는 수내1·2·3동을 서로 다른
색으로 함께 보면서 분당구 전체 범위도 같이 확인할 수 있습니다.

**공개 주소**: https://chaejwan.github.io/HDHR_CJW/district/

초성 검색(`ㅅㄴ` → 수내동), 구역별·합계 면적, 선택 상태가 담기는 공유 URL 을 지원합니다.
데이터 준비와 다른 지역으로 넓히는 방법은 [`district/README.md`](district/README.md) 를 보세요.
